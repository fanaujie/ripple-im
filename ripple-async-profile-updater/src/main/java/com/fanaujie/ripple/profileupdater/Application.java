...
import com.fanaujie.ripple.profileupdater.consumer.processor.GroupMemberBatchUpdateProcessor;
...
public class Application {
    ...
    private ProcessorDispatcher<ProfileUpdatePayload.PayloadCase, ProfileUpdatePayload, Void>
            createProcessorDispatcher(
                    CassandraUserStorageFacade storageFacade,
                    ExecutorService executorService,
                    GenericProducer<String, PushMessage> pushMessageProducer,
                    String pushTopic) {
        ...
        processor.RegisterProcessor(
                ProfileUpdatePayload.PayloadCase.GROUP_MEMBER_BATCH_UPDATE_DATA,
                new GroupMemberBatchUpdateProcessor(storageFacade, executorService));
        processor.RegisterProcessor(
