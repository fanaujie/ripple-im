...
public class CreateGroupProcessor implements Processor<SendGroupCommandReq, SendGroupCommandResp> {

    private final Logger logger = LoggerFactory.getLogger(CreateGroupProcessor.class);
    private final String topicName;
    private final GenericProducer<String, MessagePayload> producer;
    private final ExecutorService executorService;
    private final RippleStorageFacade storageFacade;

    public CreateGroupProcessor(
            String topicName,
