...
import com.fanaujie.ripple.communication.messaging.kafka.KafkaGenericProducer;
import com.fanaujie.ripple.communication.messaging.kafka.KafkaProducerConfigFactory;
import com.fanaujie.ripple.msgapiserver.listener.impl.RelationEventListener;
import com.fanaujie.ripple.msgapiserver.listener.impl.SelfInfoUpdateEventListener;
import com.fanaujie.ripple.msgapiserver.processor.EventProcessor;
import com.fanaujie.ripple.msgapiserver.processor.impl.DefaultEventProcessor;
import com.fanaujie.ripple.msgapiserver.processor.impl.DefaultMessageProcessor;
...
public class Application {
        ...
        GrpcServer grpcServer =
                new GrpcServer(
                        ...
                        createEventProcessor(
                                brokerTopic, relationStorage, producer, executorService));
    ...
    private EventProcessor createEventProcessor(
        ...
        eventProcessor.RegisterEventListener(
                SendEventReq.EventCase.SELF_INFO_UPDATE_EVENT,
                new SelfInfoUpdateEventListener(topic, relationStorage, producer, executorService));
        eventProcessor.RegisterEventListener(
                SendEventReq.EventCase.RELATION_EVENT,
                new RelationEventListener(topic, relationStorage, producer, executorService));
