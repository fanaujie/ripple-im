...
public abstract class AbstractRelationStorageTest {
    ...
    void addFriend_shouldCreateFriendRelation()
        ...
        getStorageFacade().addFriend(event, System.currentTimeMillis());

        Relation relation = getStorageFacade().getRelationBetweenUser(userId, friendId);
    ...
    void addFriend_shouldThrowException_whenAlreadyFriends()
        ...
        assertThrows(RelationAlreadyExistsException.class, () -> getStorageFacade().addFriend(event, System.currentTimeMillis()));
    }
    ...
    void removeFriend_shouldDeleteFriendRelation()
        ...
        RelationEvent addEvent =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(friendId).build();
        getStorageFacade().addFriend(addEvent, System.currentTimeMillis());

        RelationEvent removeEvent =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(friendId).build();
        getStorageFacade().removeFriend(removeEvent, System.currentTimeMillis());
    ...
    void removeFriend_shouldThrowException_whenNotFriends() {
        ...
        assertThrows(NotFoundRelationException.class, () -> getStorageFacade().removeFriend(event, System.currentTimeMillis()));
    }
    ...
    void getRelations_shouldReturnFirstPage()
        ...
        PagedRelationResult result = getStorageFacade().getRelations(userId, null, 3);
    ...
    void getRelations_shouldReturnSecondPageWithToken()
        ...
        PagedRelationResult firstPage = getStorageFacade().getRelations(userId, null, 3);
        PagedRelationResult secondPage =
                getStorageFacade().getRelations(userId, firstPage.getNextPageToken(), 3);
    ...
    void getRelations_shouldReturnEmptyResult_whenNoRelations() {
        ...
        PagedRelationResult result = getStorageFacade().getRelations(userId, null, 10);
    ...
    void getRelationBetweenUser_shouldReturnNull_whenNoRelation() {
        ...
        Relation relation = getStorageFacade().getRelationBetweenUser(userId, notFriendId);
        assertNull(relation);
    }
    ...
    void getFriendIds_shouldReturnFriendIds()
        ...
        getStorageFacade().addFriend(event1, System.currentTimeMillis());
        getStorageFacade().addFriend(event2, System.currentTimeMillis());

        UserIds friendIds = getStorageFacade().getFriendIds(userId);
    ...
    void updateFriendRemarkName_shouldUpdateRemarkName()
        ...
        RelationEvent updateEvent =
                RelationEvent.newBuilder()
                        ...
                        .build();
        getStorageFacade().updateFriendRemarkName(updateEvent, System.currentTimeMillis());
    ...
    void updateFriendRemarkName_shouldThrowException_whenNotFriends() {
        ...
        assertThrows(NotFoundRelationException.class, () -> getStorageFacade().updateFriendRemarkName(event, System.currentTimeMillis()));
    }
    ...
    void blockFriend_shouldSetBlockedFlag()
        ...
        RelationEvent blockEvent =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(friendId).build();
        getStorageFacade().blockFriend(blockEvent, System.currentTimeMillis());
    ...
    void blockFriend_shouldThrowException_whenAlreadyBlocked()
        ...
        assertThrows(BlockAlreadyExistsException.class, () -> getStorageFacade().blockFriend(blockEvent, System.currentTimeMillis()));
    }
    ...
    void blockFriend_shouldCreateBlockRelation_whenNotFriends()
        ...
        Relation relation = getStorageFacade().getRelationBetweenUser(userId, strangerId);
        assertNotNull(relation);
        assertTrue(RelationFlags.BLOCKED.isSet(relation.getRelationFlags()));
    ...
    void blockStranger_shouldBlockStranger()
        ...
        RelationEvent event =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(strangerId).build();
        getStorageFacade().blockStranger(event, System.currentTimeMillis());
    ...
    void blockStranger_shouldThrowException_whenAlreadyHasRelation()
        ...
        assertThrows(
                StrangerHasRelationshipException.class, () -> getStorageFacade().blockStranger(blockEvent, System.currentTimeMillis()));
    }
    ...
    void unblockUser_shouldRemoveBlockedFlag()
        ...
        RelationEvent unblockEvent =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(friendId).build();
        getStorageFacade().unblockUser(unblockEvent, System.currentTimeMillis());
    ...
    void unblockUser_shouldThrowException_whenNotBlocked() {
        ...
        assertThrows(NotFoundBlockException.class, () -> getStorageFacade().unblockUser(event, System.currentTimeMillis()));
    }
    ...
    void hideBlockedUser_shouldSetHiddenFlag()
        ...
        RelationEvent hideEvent =
                RelationEvent.newBuilder().setUserId(userId).setTargetUserId(friendId).build();
        getStorageFacade().hideBlockedUser(hideEvent, System.currentTimeMillis());
    ...
    void hideBlockedUser_shouldThrowException_whenNotBlocked() {
        ...
        assertThrows(NotFoundBlockException.class, () -> getStorageFacade().hideBlockedUser(event, System.currentTimeMillis()));
    }
    ...
    void isBlocked_shouldReturnTrue_whenUserBlocked()
        ...
        assertTrue(getStorageFacade().isBlocked(userId, friendId));
    }
    ...
    void isBlocked_shouldReturnFalse_whenNoRelation() {
        ...
        assertFalse(getStorageFacade().isBlocked(userId, strangerId));
    }
    ...
    void isBlocked_shouldReturnFalse_whenNotBlocked()
        ...
        assertFalse(getStorageFacade().isBlocked(userId, friendId));
    }
    ...
    void isBlocked_shouldCheckCorrectDirection()
        ...
        assertTrue(getStorageFacade().isBlocked(aliceId, bobId));

        // Bob did NOT block Alice: isBlocked(bob, alice) = false
        assertFalse(getStorageFacade().isBlocked(bobId, aliceId));
    }
    ...
    void getRelationChanges_shouldReturnChangesAfterVersion() throws Exception {
        ...
        RelationEvent remarkEvent =
                RelationEvent.newBuilder()
                        ...
                        .setTargetUserRemarkName("Best Friend")
                        .build();
        getStorageFacade().updateFriendRemarkName(remarkEvent, System.currentTimeMillis());

        String afterVersion = String.valueOf(afterVersionLong);

        List<RelationVersionChange> changes =
                getStorageFacade().getRelationChanges(userId, afterVersion, 10);
    ...
    void getRelationChanges_shouldThrowException_whenNullVersion() {
        ...
        assertThrows(
                ...
                () -> getStorageFacade().getRelationChanges(userId, null, 10));
    }
    ...
    void getRelationChanges_shouldThrowException_whenEmptyVersion() {
        ...
        assertThrows(
                InvalidVersionException.class,
                () -> getStorageFacade().getRelationChanges(userId, "", 10));
    }
    ...
    void getLatestRelationVersion_shouldReturnLatestVersion() throws Exception {
        ...
        String latestVersion = getStorageFacade().getLatestRelationVersion(userId);
    ...
    protected void createFriendsForPagination(long userId, int count)
            throws NotFoundUserProfileException, RelationAlreadyExistsException {
