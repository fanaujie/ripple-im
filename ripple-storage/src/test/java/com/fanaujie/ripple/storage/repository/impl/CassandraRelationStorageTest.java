...
//        UserProfile friendProfile = new UserProfile(2000L, "friend1", "Friend One",
// "avatar1.jpg");
//
...
//        UserProfile friendProfile = new UserProfile(2001L, "friend2", "Friend Two",
// "avatar2.jpg");
//
...
//        UserProfile friendProfile = new UserProfile(2005L, "friend6", "Friend Six",
// "avatar6.jpg");
//
//        // Add friend first
//        relationRepository.addFriend(initiatorId, friendProfile);
...
//
//        // Update remark name
//        relationRepository.updateFriendRemarkName(
...
//                NotFoundRelationException.class,
//                () -> {
//                    relationRepository.updateFriendRemarkName(9999L, 8888L, "New Remark");
//                });
//    }
//
//    // ==================== isFriends Tests ====================
...
//        long userId = 1008L;
//        UserProfile friendProfile = new UserProfile(2010L, "friend9", "Friend Nine",
// "avatar9.jpg");
//
//        // Add as friend first
...
//        UserProfile friend2 = new UserProfile(2017L, "friend13", "Friend Thirteen",
// "avatar13.jpg");
//        UserProfile friend3 = new UserProfile(2018L, "friend14", "Friend Fourteen",
// "avatar14.jpg");
//
...
//        long userId = 1015L;
//        UserProfile friend1 = new UserProfile(2019L, "friend15", "Friend Fifteen",
// "avatar15.jpg");
//        UserProfile friend2 = new UserProfile(2020L, "friend16", "Friend Sixteen",
// "avatar16.jpg");
//
//        // Add two friends
//        relationRepository.addFriend(userId, friend1);
...
//        List<RelationVersionChange> changes1 =
//                relationRepository.getRelationChanges(userId, versionBeforeFriend1.toString(),
// 10);
...
//        List<RelationVersionChange> changes2 =
//                relationRepository.getRelationChanges(userId, versionBeforeFriend1.toString(),
// 10);
...
//
//        // Update remark name
//        relationRepository.updateFriendRemarkName(userId, 4001L, "Best Friend");
//
//        // Query changes after versionBeforeUpdate
//        List<RelationVersionChange> changes3 =
...
//        for (int i = 0; i < 5; i++) {
//            UserProfile friend =
//                    new UserProfile(5000L + i, "friend" + i, "Friend " + i, "avatar" + i +
// ".jpg");
...
//
//        // Update remark name
//        relationRepository.updateFriendRemarkName(userId, 6000L, "Updated Name");
//        Thread.sleep(10);
//
//        // Remove friend
