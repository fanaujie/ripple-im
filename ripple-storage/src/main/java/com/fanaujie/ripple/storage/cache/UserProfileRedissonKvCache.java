...
public class UserProfileRedissonKvCache {
    private final Logger logger = LoggerFactory.getLogger(UserProfileRedissonKvCache.class);
    ...
    public UserProfileRedissonKvCache(
