...
public abstract class AbstractGroupStorageTest {
    ...
    void createGroup_shouldCreateGroupMembers() throws NotFoundGroupException {
        ...
        getStorageFacade().createGroup(groupId, members, version);

        List<Long> memberIds = getStorageFacade().getGroupMemberIds(groupId);
    ...
    void createGroup_shouldCreateVersionRecord() throws InvalidVersionException {
        ...
        List<GroupVersionChange> changes = getStorageFacade().getGroupChanges(groupId, null, 10);
    ...
    void createUserGroupAndConversation_shouldCreateUserGroupEntry() {
        ...
        getStorageFacade().createUserGroupAndConversation(userId, groupId, groupName, groupAvatar, version);

        List<UserGroup> groups = getStorageFacade().getUserGroups(userId);
    ...
    void createGroupMembersProfile_shouldAddMembersToGroup() throws NotFoundGroupException {
        ...
        getStorageFacade().createGroup(groupId, initialMembers, version1);
        ...
        getStorageFacade().createGroupMembersProfile(groupId, newMembers, version2);
    ...
    void updateGroupMemberName_shouldUpdateMemberName() throws NotFoundGroupException {
        ...
        getStorageFacade().createGroup(
                groupId,
                Arrays.asList(new UserProfile(userId, "user20", originalName, "avatar.png")),
                version1);

        long version2 = version1 + 1;
        getStorageFacade().updateGroupMemberName(groupId, userId, newName, version2);

        List<GroupMemberInfo> members = getStorageFacade().getGroupMembersInfo(groupId);
    ...
    void updateGroupMemberAvatar_shouldUpdateMemberAvatar() throws NotFoundGroupException {
        ...
        long version2 = version1 + 1;
        getStorageFacade().updateGroupMemberAvatar(groupId, userId, newAvatar, version2);
    ...
    void removeGroupMember_shouldDeleteMember() throws NotFoundGroupException {
        ...
        long version2 = version1 + 1;
        getStorageFacade().removeGroupMember(groupId, userId1, version2);
    ...
    void getGroupMemberIds_shouldReturnMemberIds() throws NotFoundGroupException {
        ...
        getStorageFacade().createGroup(groupId, members, System.currentTimeMillis());
    ...
    void getGroupMemberIds_shouldThrowExceptionWhenGroupNotFound() {
        ...
        assertThrows(
                NotFoundGroupException.class, () -> getStorageFacade().getGroupMemberIds(nonExistentGroupId));
    }
    ...
    void getGroupMembersInfo_shouldReturnMemberInfo() throws NotFoundGroupException {
        ...
        List<GroupMemberInfo> memberInfos = getStorageFacade().getGroupMembersInfo(groupId);
    ...
    void getGroupMembersInfo_shouldThrowExceptionWhenGroupNotFound() {
        ...
        assertThrows(
                ...
                () -> getStorageFacade().getGroupMembersInfo(nonExistentGroupId));
    }
    ...
    void getUserGroupIds_shouldReturnGroupIds() {
        long userId = 3010L;
        long version = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, 1011L, "Group1", "a.png", version);
        getStorageFacade().createUserGroupAndConversation(userId, 1012L, "Group2", "b.png", version + 1);

        List<Long> groupIds = getStorageFacade().getUserGroupIds(userId);
    ...
    void getUserGroupIds_shouldReturnEmptyListWhenNoGroups() {
        ...
        List<Long> groupIds = getStorageFacade().getUserGroupIds(userWithNoGroups);
    ...
    void getUserGroups_shouldReturnUserGroups() {
        long userId = 3012L;
        long version = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, 1013L, "Group One", "avatar1.png", version);
    ...
    void getGroupMembersPaged_shouldReturnFirstPage() throws NotFoundGroupException {
        ...
        PagedGroupMemberResult result = getStorageFacade().getGroupMembersPaged(groupId, null, 3);
    ...
    void getGroupMembersPaged_shouldReturnSecondPage() throws NotFoundGroupException {
        ...
        PagedGroupMemberResult firstPage = getStorageFacade().getGroupMembersPaged(groupId, null, 3);
        PagedGroupMemberResult secondPage = 
                getStorageFacade().getGroupMembersPaged(groupId, firstPage.getNextPageToken(), 3);
    ...
    void getUserGroupsPaged_shouldReturnFirstPage() {
        ...
        long version = System.currentTimeMillis();
        for (int i = 0; i < 5; i++) {
            getStorageFacade().createUserGroupAndConversation(
                    userId, 1020L + i, "Group" + i, "avatar.png", version + i);
        }

        PagedUserGroupResult result = getStorageFacade().getUserGroupsPaged(userId, null, 3);
    ...
    void getUserGroupsPaged_shouldReturnSecondPage() {
        ...
        PagedUserGroupResult firstPage = getStorageFacade().getUserGroupsPaged(userId, null, 3);
        PagedUserGroupResult secondPage = 
                getStorageFacade().getUserGroupsPaged(userId, firstPage.getNextPageToken(), 3);
    ...
    void getLatestGroupVersion_shouldReturnLatestVersion() {
        ...
        getStorageFacade().createGroup(
                ...
                version1);
        getStorageFacade().updateGroupMemberName(groupId, 2070L, "Updated Name", version2);

        String latestVersion = getStorageFacade().getLatestGroupVersion(groupId);
    ...
    void getLatestGroupVersion_shouldReturnNullWhenNoVersions() {
        ...
        String latestVersion = getStorageFacade().getLatestGroupVersion(nonExistentGroupId);
    ...
    void getLatestUserGroupVersion_shouldReturnLatestVersion() {
        long userId = 3030L;
        long version = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, 1050L, "Group", "a.png", version);

        String latestVersion = getStorageFacade().getLatestUserGroupVersion(userId);
    ...
    void removeUserGroup_shouldDeleteUserGroup() {
        ...
        long groupId = 1051L;
        long version1 = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, groupId, "Group", "a.png", version1);

        long version2 = version1 + 1;
        getStorageFacade().removeUserGroup(userId, groupId, version2);
    ...
    void updateUserGroupName_shouldUpdateName() {
        ...
        long version1 = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, groupId, originalName, "a.png", version1);

        long version2 = version1 + 1;
        getStorageFacade().updateUserGroupName(userId, groupId, newName, version2);
    ...
    void updateUserGroupAvatar_shouldUpdateAvatar() {
        ...
        String newAvatar = "updated.png";
        long version1 = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, groupId, "Group", originalAvatar, version1);

        long version2 = version1 + 1;
        getStorageFacade().updateUserGroupAvatar(userId, groupId, newAvatar, version2);
    ...
    void getUserGroupChanges_shouldReturnChangesAfterVersion() throws InvalidVersionException {
        ...
        long version1 = 1000L;
        long version2 = 2000L;
        getStorageFacade().createUserGroupAndConversation(userId, 1054L, "Group1", "a.png", version1);
        getStorageFacade().createUserGroupAndConversation(userId, 1055L, "Group2", "b.png", version2);

        List<UserGroupVersionChange> changes = 
                getStorageFacade().getUserGroupChanges(userId, String.valueOf(version1), 10);
    ...
    void getUserGroupChanges_shouldThrowExceptionForInvalidVersion() {
        ...
        assertThrows(
                ...
                () -> getStorageFacade().getUserGroupChanges(userId, invalidVersion, 10));
    }
    ...
    void getGroupChanges_shouldReturnChangesAfterVersion() throws InvalidVersionException {
        ...
        getStorageFacade().createGroup(
                ...
                version1);
        getStorageFacade().updateGroupMemberName(groupId, 2080L, "Updated Name", version2);

        List<GroupVersionChange> changes = 
                getStorageFacade().getGroupChanges(groupId, String.valueOf(version1), 10);
    ...
    void getGroupChanges_shouldThrowExceptionForInvalidVersion() {
        long groupId = 1057L; String invalidVersion = "not-a-number";

        assertThrows(
                InvalidVersionException.class,
                () -> getStorageFacade().getGroupChanges(groupId, invalidVersion, 10));
    }
    ...
    void saveGroupCommandMessage_shouldSaveCommandMessage() {
        ...
        getStorageFacade().saveGroupCommandMessage(
                conversationId, messageId, senderId, groupId, timestamp, commandType, commandData);

        Messages messages = getStorageFacade().getMessages(conversationId, 0, 10);
    ...
    void removeGroupConversation_shouldRemoveConversation() {
        ...
        long groupId = 1060L;
        long version = System.currentTimeMillis();
        getStorageFacade().createUserGroupAndConversation(userId, groupId, "Group", "a.png", version);

        PagedConversationResult before = getStorageFacade().getConversations(userId, null, 10);
        assertEquals(1, before.getConversations().size());

        getStorageFacade().removeGroupConversation(userId, groupId, System.currentTimeMillis());

        PagedConversationResult after = getStorageFacade().getConversations(userId, null, 10);
