...
class UploadControllerTest {
    ...
    private MockMultipartFile createInvalidTypeFile() {
        return new MockMultipartFile("avatar", "test.txt", "text/plain", "test content".getBytes());
    }
    ...
    private RequestPostProcessor authenticatedUser() {
        return jwt().authorities(new SimpleGrantedAuthority("user"))
    ...
    void uploadAvatar_ImageDimensionValidationError() throws Exception {
        ...
        MockMultipartFile file = createTestImageFile();
        AvatarUploadResponse errorResponse =
                new AvatarUploadResponse(400, "Image dimensions exceed maximum allowed size", null);
